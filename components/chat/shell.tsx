...
export function ChatShell() {
  ...
  return (
    <div className="flex h-dvh w-full flex-row overflow-hidden supports-[height:100svh]:h-svh supports-[height:100dvh]:h-dvh">
      <div className={cn("flex min-w-0 flex-1 flex-col bg-sidebar")}>
        ...
        <div className="relative flex min-h-0 flex-1 flex-col overflow-hidden bg-background md:rounded-tl-[12px] md:border-t md:border-l md:border-border/40">
          ...
          <div className="sticky bottom-0 z-1 mx-auto flex w-full max-w-4xl gap-2 border-t-0 bg-background px-2 pt-2 pb-[calc(0.75rem_+_env(safe-area-inset-bottom))] md:px-4 md:pb-4">
            {!isReadonly && (
              <MultimodalInput
      ...
      {isMobile && (
        <Sheet onOpenChange={setIsWorkbenchOpen} open={isWorkbenchOpen}>
          <SheetContent
            className="inset-0 h-dvh !w-screen !max-w-none p-0 sm:!max-w-none"
